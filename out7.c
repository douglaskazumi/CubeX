...
object_t * c_Pair(object_t *ca_0, object_t *ca_1);
void cint_Pair(object_t *this, object_t *ca_0, object_t *ca_1);
object_t * _Pair_pi1(object_t *this);
object_t * _Pair_pi2(object_t *this);
object_t * c_Map(object_t *ca_0);
void cint_Map(object_t *this, object_t *ca_0);
object_t * _Map_add(object_t *this,  object_t *  v_key,  object_t *  v_val);
object_t * _Map_lookup(object_t *this,  object_t *  v_key);
object_t *v_input;
	object_t * v_ret = NULL;
...
/*Map*/
	...
	vtable->iTable = itable;
	curVEntry = (func *)(vtable+1);
	*(curVEntry)=(func)(_Map_add);
	curVEntry++;
	*(curVEntry)=(func)(_Map_lookup);
	curVEntry++;
	vt_Map = vtable;
/*Pair*/
	vtable = x3malloc(sizeof(vTable_t) + 2*sizeof(func));
	...
	vtable->iTable = itable;
	curVEntry = (func *)(vtable+1);
	*(curVEntry)=(func)(_Pair_pi1);
	curVEntry++;
	*(curVEntry)=(func)(_Pair_pi2);
	curVEntry++;
	vt_Pair = vtable;
/*String*/
...
cint_Pair(this, gc_dec(ca_0), gc_dec(ca_1));
return gc_dec(this);
}

void cint_Pair(object_t *this, object_t *ca_0, object_t *ca_1)
{
*(((object_t **)(this+1))+1) = gc_inc(ca_0);
*(((object_t **)(this+1))+0) = gc_inc(ca_1);
}

object_t * c_Map(object_t *ca_0)
{
object_t * this = createObject(6, 1);
cint_Map(this, gc_dec(ca_0));
return gc_dec(this);
}
...
object_t * _Pair_pi1(object_t *this)
{
	...
	vtemp_0 = gc_inc(*(((object_t **)(this+1))+1));
gc_dec(this);
...
object_t * _Map_add(object_t *this,  object_t *  v_key,  object_t *  v_val)
{
	...
	vtemp_2 = gc_inc((c_Map(gc_inc(iterableAppend(*(((object_t **)(this+1))+0), createIterable_value((c_Pair(gc_inc(v_key), gc_inc(v_val))), 0))))));
	gc(gc_dec(v_key));
	gc(gc_dec(v_val));
gc_dec(this);
	return gc_dec(vtemp_2);
...
object_t * _Map_lookup(object_t *this,  object_t *  v_key)
{
	...
	object_t * vtemp_6 = NULL;
				vtemp_3 = (object_t *)createIndexer();
	vtemp_4 = gc_inc(*(((object_t **)(this+1))+0));
	while(iterableHasNext(vtemp_4, (iterableIndex_t *)vtemp_3))
	{
		v_p = gc_inc(iterableNext(vtemp_4, (iterableIndex_t *)vtemp_3));
		vtemp_5 = gc_inc(v_p);
vtemp_6 = gc_inc((((object_t * (*)(object_t *))(getMethod(vtemp_5, 5, 0)))(gc_inc(vtemp_5))));
		if((bool)isTrue((((object_t * (*)(object_t *, object_t *))(getMethod(vtemp_6, 3, 0)))(gc_inc(vtemp_6), gc_inc(v_key)))))
{
		vtemp_7 = gc_inc(v_p);
			vtemp_8 = gc_inc(createIterable_value((((object_t * (*)(object_t *))(getMethod(vtemp_7, 5, 1)))(gc_inc(vtemp_7))), 0));
		gc(gc_dec(vtemp_7));
		vtemp_7 = NULL;
	gc(gc_dec(v_key));
	gc(gc_dec(vtemp_7));
...
gc_dec(this);
	return gc_dec(vtemp_8);
		...
		gc_iterableIndex((iterableIndex_t *)vtemp_3);
		vtemp_3 = NULL;
		gc(gc_dec(vtemp_4));
		vtemp_4 = NULL;
					vtemp_9 = gc_inc(NULL);
...
object_t * cubex_main_int()
{
	...
	init_VTables();
		...
		vtemp_10 = (object_t *)(v_x);
	v_x = (gc_inc(((c_Map(gc_inc(NULL))))));
	gc(gc_dec(vtemp_10));
	vtemp_10 = NULL;
		vtemp_11 = (object_t *)(v_v);
	v_v = (gc_inc((createInteger(102, 0))));
	gc(gc_dec(vtemp_11));
	vtemp_11 = NULL;
	vtemp_12 = (object_t *)createIndexer();
	vtemp_13 = gc_inc(v_input);
	while(iterableHasNext(vtemp_13, (iterableIndex_t *)vtemp_12))
	{
		v_i = gc_inc(iterableNext(vtemp_13, (iterableIndex_t *)vtemp_12));
				vtemp_14 = gc_inc(v_x);
			vtemp_15 = (object_t *)(v_x);
	v_x = (gc_inc(((((object_t * (*)(object_t *, object_t *, object_t *))(getMethod(vtemp_14, 6, 0)))(gc_inc(vtemp_14), gc_inc(v_i), gc_inc(v_v))))));
	gc(gc_dec(vtemp_15));
	vtemp_15 = NULL;
		gc(gc_dec(vtemp_14));
		vtemp_14 = NULL;
		vtemp_16 = gc_inc(v_v);
			vtemp_17 = (object_t *)(v_v);
	v_v = (gc_inc(((((object_t * (*)(object_t *, object_t *))(getMethod(vtemp_16, 0, 4)))(gc_inc(vtemp_16), gc_inc(createInteger(1, 0)))))));
	gc(gc_dec(vtemp_17));
	vtemp_17 = NULL;
		gc(gc_dec(vtemp_16));
		vtemp_16 = NULL;
		...
		gc_iterableIndex((iterableIndex_t *)vtemp_12);
		vtemp_12 = NULL;
		gc(gc_dec(vtemp_13));
		vtemp_13 = NULL;
		vtemp_18 = (object_t *)(v_ret);
	v_ret = (gc_inc((NULL)));
	gc(gc_dec(vtemp_18));
	vtemp_18 = NULL;
	vtemp_19 = (object_t *)createIndexer();
	vtemp_20 = gc_inc(v_input);
	while(iterableHasNext(vtemp_20, (iterableIndex_t *)vtemp_19))
	{
		v_i = gc_inc(iterableNext(vtemp_20, (iterableIndex_t *)vtemp_19));
				vtemp_21 = gc_inc(v_x);
			vtemp_22 = (object_t *)(v_z);
	v_z = (gc_inc(((((object_t * (*)(object_t *, object_t *))(getMethod(vtemp_21, 6, 1)))(gc_inc(vtemp_21), gc_inc(v_i))))));
	gc(gc_dec(vtemp_22));
	vtemp_22 = NULL;
		gc(gc_dec(vtemp_21));
		vtemp_21 = NULL;
					vtemp_23 = (object_t *)(v_zz);
	v_zz = (gc_inc((NULL)));
	gc(gc_dec(vtemp_23));
	vtemp_23 = NULL;
				vtemp_24 = (object_t *)createIndexer();
	vtemp_25 = gc_inc(v_z);
	while(iterableHasNext(vtemp_25, (iterableIndex_t *)vtemp_24))
	{
		v_j = gc_inc(iterableNext(vtemp_25, (iterableIndex_t *)vtemp_24));
			vtemp_26 = (object_t *)(v_zz);
	v_zz = (gc_inc((iterableAppend(v_zz, createIterable_value((__character(gc_inc(v_j))), 0)))));
	gc(gc_dec(vtemp_26));
	vtemp_26 = NULL;
		gc(gc_dec(v_j));
		v_j = NULL;
	}
		gc_iterableIndex((iterableIndex_t *)vtemp_24);
		vtemp_24 = NULL;
		gc(gc_dec(vtemp_25));
		vtemp_25 = NULL;
					vtemp_27 = (object_t *)(v_ret);
	v_ret = (gc_inc((iterableAppend(v_ret, createIterable_value((__string(gc_inc(v_zz))), 0)))));
	gc(gc_dec(vtemp_27));
	vtemp_27 = NULL;
		gc(gc_dec(v_i));
		v_i = NULL;
	}
		gc_iterableIndex((iterableIndex_t *)vtemp_19);
		vtemp_19 = NULL;
		gc(gc_dec(vtemp_20));
		vtemp_20 = NULL;
