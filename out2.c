...
object_t * __safeDiv( object_t *  v_l,  object_t *  v_r,  object_t *  v_d)
{
	...
	object_t * vtemp_2 = NULL;
		vtemp_0 = gc_inc(v_l);
			vtemp_1 = (object_t *)(v_m);
	v_m = (gc_inc(((((object_t * (*)(object_t *, object_t *))(getMethod(vtemp_0, 0, 2)))(gc_inc(vtemp_0), gc_inc(v_r))))));
	gc(gc_dec(vtemp_1));
	vtemp_1 = NULL;
		gc(gc_dec(vtemp_0));
		vtemp_0 = NULL;
	...
	{
		v_i = gc_inc(iterableNext(vtemp_3, (iterableIndex_t *)vtemp_2));
			vtemp_4 = gc_inc(v_i);
	gc(gc_dec(v_l));
	gc(gc_dec(v_r));
	gc(gc_dec(v_d));
...
object_t * __safeModulo( object_t *  v_l,  object_t *  v_r,  object_t *  v_d)
{
	...
	object_t * v_i = NULL;
		vtemp_6 = gc_inc(v_l);
			vtemp_7 = (object_t *)(v_m);
	v_m = (gc_inc(((((object_t * (*)(object_t *, object_t *))(getMethod(vtemp_6, 0, 3)))(gc_inc(vtemp_6), gc_inc(v_r))))));
	gc(gc_dec(vtemp_7));
	vtemp_7 = NULL;
		gc(gc_dec(vtemp_6));
		vtemp_6 = NULL;
				vtemp_8 = (object_t *)createIndexer();
	vtemp_9 = gc_inc(v_m);
	while(iterableHasNext(vtemp_9, (iterableIndex_t *)vtemp_8))
	{
		v_i = gc_inc(iterableNext(vtemp_9, (iterableIndex_t *)vtemp_8));
			vtemp_10 = gc_inc(v_i);
	gc(gc_dec(v_l));
	gc(gc_dec(v_r));
	gc(gc_dec(v_d));
	...
	return gc_dec(vtemp_10);
		...
		gc_iterableIndex((iterableIndex_t *)vtemp_8);
		vtemp_8 = NULL;
		gc(gc_dec(vtemp_9));
		vtemp_9 = NULL;
					vtemp_11 = gc_inc(v_d);
...
object_t * __intToStr( object_t *  v_i)
{
	...
	object_t * v_pref = NULL;
					vtemp_12 = (object_t *)(v_pref);
	v_pref = (gc_inc((NULL)));
	gc(gc_dec(vtemp_12));
	vtemp_12 = NULL;
		vtemp_13 = gc_inc(v_i);
		if((bool)isTrue((((object_t * (*)(object_t *, object_t *, object_t *))(getMethod(vtemp_13, 0, 8)))(gc_inc(vtemp_13), gc_inc(createInteger(0, 0)), gc_inc(createBoolean(true, 0))))))
{
									vtemp_14 = (object_t *)(v_pref);
	v_pref = (gc_inc((createIterable_string("-", 1, 0, true))));
	gc(gc_dec(vtemp_14));
	vtemp_14 = NULL;
		vtemp_15 = gc_inc(v_i);
vtemp_16 = gc_inc(createInteger(1, 0));
			vtemp_17 = (object_t *)(v_i);
	v_i = (gc_inc(((((object_t * (*)(object_t *, object_t *))(getMethod(vtemp_15, 0, 1)))(gc_inc(vtemp_15), gc_inc((((object_t * (*)(object_t *))(getMethod(vtemp_16, 0, 0)))(gc_inc(vtemp_16)))))))));
	gc(gc_dec(vtemp_17));
	vtemp_17 = NULL;
		gc(gc_dec(vtemp_15));
		vtemp_15 = NULL;
		...
		gc(gc_dec(vtemp_13));
		vtemp_13 = NULL;
		vtemp_18 = gc_inc(createInteger(48, 0));
			vtemp_19 = (object_t *)(v_ret);
	v_ret = (gc_inc((createIterable_value((__character(gc_inc((((object_t * (*)(object_t *, object_t *))(getMethod(vtemp_18, 0, 4)))(gc_inc(vtemp_18), gc_inc((__safeModulo(gc_inc(v_i), gc_inc(createInteger(10, 0)), gc_inc(createInteger(0, 0)))))))))), 0))));
	gc(gc_dec(vtemp_19));
	vtemp_19 = NULL;
		gc(gc_dec(vtemp_18));
		vtemp_18 = NULL;
					vtemp_20 = (object_t *)(v_i);
	v_i = (gc_inc(((__safeDiv(gc_inc(v_i), gc_inc(createInteger(10, 0)), gc_inc(createInteger(0, 0)))))));
	gc(gc_dec(vtemp_20));
	vtemp_20 = NULL;
				while(true)
	{
vtemp_21 = gc_inc(createInteger(0, 0));
	if(!((bool)(isTrue((((object_t * (*)(object_t *, object_t *, object_t *))(getMethod(vtemp_21, 0, 8)))(gc_inc(vtemp_21), gc_inc(v_i), gc_inc(createBoolean(true, 0))))))))
	{
		gc(gc_dec(vtemp_21));
		vtemp_21 = NULL;
		break;
		...
		vtemp_21 = NULL;
						...
						vtemp_22 = gc_inc(createInteger(48, 0));
			vtemp_23 = (object_t *)(v_ret);
	v_ret = (gc_inc((iterableAppend(createIterable_value((__character(gc_inc((((object_t * (*)(object_t *, object_t *))(getMethod(vtemp_22, 0, 4)))(gc_inc(vtemp_22), gc_inc((__safeModulo(gc_inc(v_i), gc_inc(createInteger(10, 0)), gc_inc(createInteger(0, 0)))))))))), 0), v_ret))));
	gc(gc_dec(vtemp_23));
	vtemp_23 = NULL;
		gc(gc_dec(vtemp_22));
		vtemp_22 = NULL;
					vtemp_24 = (object_t *)(v_i);
	v_i = (gc_inc(((__safeDiv(gc_inc(v_i), gc_inc(createInteger(10, 0)), gc_inc(createInteger(0, 0)))))));
	gc(gc_dec(vtemp_24));
	vtemp_24 = NULL;
	}
					vtemp_25 = gc_inc((__string(gc_inc(iterableAppend(v_pref, v_ret)))));
	gc(gc_dec(v_i));
	gc(gc_dec(v_ret));
	gc(gc_dec(vtemp_18));
	gc(gc_dec(vtemp_19));
...
object_t * cubex_main_int()
{
	...
	vtemp_26 = gc_inc(createInteger(1, 0));
	vtemp_27 = (object_t *)createIndexer();
	vtemp_28 = gc_inc(iterableAppend((((object_t * (*)(object_t *, object_t *, object_t *, object_t *))(getMethod(vtemp_26, 0, 6)))(gc_inc(vtemp_26), gc_inc(createInteger(5, 0)), gc_inc(createBoolean(true, 0)), gc_inc(createBoolean(true, 0)))), createIterable_value(createInteger(6, 0), 0)));
	while(iterableHasNext(vtemp_28, (iterableIndex_t *)vtemp_27))
	{
		v_i = gc_inc(iterableNext(vtemp_28, (iterableIndex_t *)vtemp_27));
			vtemp_29 = gc_inc(createIterable_value((__intToStr(gc_inc(v_i))), 0));
	gc(gc_dec(vtemp_27));
	gc(gc_dec(vtemp_28));
	gc(gc_dec(v_i));
	gc(gc_dec(vtemp_26));
	return gc_dec(vtemp_29);
		gc(gc_dec(v_i));
		v_i = NULL;
	}
		gc_iterableIndex((iterableIndex_t *)vtemp_27);
		vtemp_27 = NULL;
		gc(gc_dec(vtemp_28));
		vtemp_28 = NULL;
		gc(gc_dec(vtemp_26));
		vtemp_26 = NULL;
		vtemp_30 = gc_inc(createIterable_value(createIterable_string("nope", 4, 0, true), 0));
	gc(gc_dec(vtemp_27));
	gc(gc_dec(vtemp_28));
	gc(gc_dec(vtemp_29));
	gc(gc_dec(v_i));
