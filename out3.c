...
object_t * __rest( object_t *  v_l)
{
	...
	object_t * v_var_cubex_temp_13 = NULL;
	object_t * v_ret = NULL;
	...
	object_t * vtemp_43 = NULL;
					vtemp_43 = (object_t *)(v_ret);
	v_ret = (gc_inc((NULL)));
	gc(gc_dec(vtemp_43));
	vtemp_43 = NULL;
					v_passed = (object_t *)false;
				vtemp_45 = (object_t *)createIndexer();
	vtemp_46 = gc_inc(v_l);
	while(iterableHasNext(vtemp_46, (iterableIndex_t *)vtemp_45))
	{
		v_e = gc_inc(iterableNext(vtemp_46, (iterableIndex_t *)vtemp_45));
						if((bool)(v_passed)){
									vtemp_47 = (object_t *)(v_var_cubex_temp_13);
	v_var_cubex_temp_13 = (gc_inc((createIterable_value(v_e, 0))));
	gc(gc_dec(vtemp_47));
	vtemp_47 = NULL;
					vtemp_48 = (object_t *)(v_ret);
	v_ret = (gc_inc((iterableAppend(v_ret, v_var_cubex_temp_13))));
	gc(gc_dec(vtemp_48));
	vtemp_48 = NULL;
	}
					v_passed = (object_t *)true;
		gc(gc_dec(v_e));
		v_e = NULL;
	}
		gc_iterableIndex((iterableIndex_t *)vtemp_45);
		vtemp_45 = NULL;
		gc(gc_dec(vtemp_46));
		vtemp_46 = NULL;
	...
	gc(gc_dec(vtemp_45));
	gc(gc_dec(vtemp_43));
	return gc_dec(vtemp_50);

}
object_t * __last( object_t *  v_l,  object_t *  v_default)
{
	object_t * v_var_cubex_temp_14 = NULL;
	object_t * v_e = NULL;
	object_t * vtemp_56 = NULL;
	object_t * v_var_cubex_temp_16 = NULL;
	object_t * vtemp_51 = NULL;
	object_t * vtemp_54 = NULL;
	object_t * vtemp_55 = NULL;
	object_t * vtemp_52 = NULL;
	object_t * vtemp_53 = NULL;
				vtemp_51 = (object_t *)createIndexer();
	vtemp_52 = gc_inc(v_l);
	while(iterableHasNext(vtemp_52, (iterableIndex_t *)vtemp_51))
	{
		v_e = gc_inc(iterableNext(vtemp_52, (iterableIndex_t *)vtemp_51));
							vtemp_53 = (object_t *)(v_var_cubex_temp_16);
	v_var_cubex_temp_16 = (gc_inc(((__rest(gc_inc(v_l))))));
	gc(gc_dec(vtemp_53));
	vtemp_53 = NULL;
					vtemp_54 = (object_t *)(v_var_cubex_temp_14);
	v_var_cubex_temp_14 = (gc_inc(((__last(gc_inc(v_var_cubex_temp_16), gc_inc(v_e))))));
	gc(gc_dec(vtemp_54));
	vtemp_54 = NULL;
					vtemp_55 = gc_inc(v_var_cubex_temp_14);
	gc(gc_dec(v_l));
	gc(gc_dec(v_default));
	gc(gc_dec(v_var_cubex_temp_14));
	gc(gc_dec(v_e));
	gc(gc_dec(v_var_cubex_temp_16));
	gc(gc_dec(vtemp_51));
	gc(gc_dec(vtemp_54));
	gc(gc_dec(vtemp_52));
	gc(gc_dec(vtemp_53));
	return gc_dec(vtemp_55);
		...
		gc_iterableIndex((iterableIndex_t *)vtemp_51);
		vtemp_51 = NULL;
		gc(gc_dec(vtemp_52));
		vtemp_52 = NULL;
					vtemp_56 = gc_inc(v_default);
	gc(gc_dec(v_l));
	gc(gc_dec(v_default));
	gc(gc_dec(v_var_cubex_temp_14));
	gc(gc_dec(v_e));
...
object_t * __length( object_t *  v_l)
{
	object_t * v_ret = NULL;
	object_t * v_e = NULL;
	object_t * vtemp_59 = NULL;
	object_t * vtemp_58 = NULL;
	object_t * vtemp_61 = NULL;
					v_ret = (object_t *)0;
				vtemp_58 = (object_t *)createIndexer();
	vtemp_59 = gc_inc(v_l);
	while(iterableHasNext(vtemp_59, (iterableIndex_t *)vtemp_58))
	{
		v_e = gc_inc(iterableNext(vtemp_59, (iterableIndex_t *)vtemp_58));
			v_ret = (object_t *)((object_t *)(((int)v_ret) + ((int)1)));
		gc(gc_dec(v_e));
		v_e = NULL;
	}
		gc_iterableIndex((iterableIndex_t *)vtemp_58);
		vtemp_58 = NULL;
		gc(gc_dec(vtemp_59));
		vtemp_59 = NULL;
gc(gc_dec(v_e));
v_e = NULL;
					vtemp_61 = (object_t *)(v_ret);
	gc(gc_dec(v_l));
	gc(gc_dec(v_e));
	gc(gc_dec(vtemp_59));
	gc(gc_dec(vtemp_58));
...
object_t * cubex_main_int()
{
	...
	init_VTables();
		...
		vtemp_62 = (object_t *)(v_var_cubex_temp_19);
	v_var_cubex_temp_19 = (gc_inc(((__last(gc_inc(v_input), gc_inc(createIterable_string("", 0, 0, true)))))));
	gc(gc_dec(vtemp_62));
	vtemp_62 = NULL;
		vtemp_63 = (object_t *)(v_var_cubex_temp_17);
	v_var_cubex_temp_17 = (gc_inc((createIterable_value(v_var_cubex_temp_19, 0))));
	gc(gc_dec(vtemp_63));
	vtemp_63 = NULL;
gc(gc_dec(v_var_cubex_temp_19));
v_var_cubex_temp_19 = NULL;
	vtemp_64 = gc_inc(box((int)5, false));
		vtemp_65 = (object_t *)(v_var_cubex_temp_20);
	v_var_cubex_temp_20 = (gc_inc(((__string(gc_inc(createIterable_value((__character((int)(((object_t *)(((int)unbox((object_t *)(__last(gc_inc((((object_t * (*)(object_t *, int, int, int))(getMethod(vtemp_64, 0, 6)))(gc_inc(vtemp_64), (int)((__length(gc_inc(v_input)))), (int)(true), (int)(true)))), gc_inc(box((int)3, false)))))) + ((int)30)))))), 0)))))));
	gc(gc_dec(vtemp_65));
	vtemp_65 = NULL;
gc(gc_dec(v_input));
v_input = NULL;
		vtemp_66 = (object_t *)(v_var_cubex_temp_18);
	v_var_cubex_temp_18 = (gc_inc((createIterable_value(v_var_cubex_temp_20, 0))));
	gc(gc_dec(vtemp_66));
	vtemp_66 = NULL;
gc(gc_dec(v_var_cubex_temp_20));
v_var_cubex_temp_20 = NULL;
		vtemp_67 = (object_t *)(v_var_cubex_temp_15);
	v_var_cubex_temp_15 = (gc_inc((iterableAppend(v_var_cubex_temp_17, v_var_cubex_temp_18))));
	gc(gc_dec(vtemp_67));
	vtemp_67 = NULL;
gc(gc_dec(v_var_cubex_temp_17));
v_var_cubex_temp_17 = NULL;
gc(gc_dec(v_var_cubex_temp_18));
v_var_cubex_temp_18 = NULL;
		vtemp_68 = gc_inc(v_var_cubex_temp_15);
	gc(gc_dec(v_ret));
